...
export default function ExpirationAlert({ itemsExpiring }: ExpirationAlertProps) {
    if (itemsExpiring === 0) return null;
    ...
    return (
        <View className="flex flex-row gap-4 rounded-lg p-4 border border-[#f97316] bg-[#f97316]/5">
            ...
            <View className="flex flex-col">
                ...
                <Text className="text-md text-black/60">{itemsExpiring} itens irão vencer em breve.</Text>
            </View>
        </View>
    )
}
